                    ...
                    <span class="product-title">
                       <a target="_blank" href="{{ route('products.show', [$item->product_id]) }}">{{ $item->product->title }}</a>
                                                    ...
                                                    @if($index === 0)
                                                        ...
                                                        <td rowspan="{{ count($order->items) }}" class="text-center"><a class="btn btn-primary btn-xs" href="{{ route('order.show', ['order' => $order->id]) }}">查看订单</a>
                                                            <!-- 评价入口开始 -->
                                                            @if($order->paid_at)
                                                                <a class="btn btn-success btn-sm" href="{{ route('order.review.show', ['order' => $order->id]) }}">
